            ...
            <header className="text-gray-600 body-font shadow-lg">
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    <NavLink to={'/'} className="flex cursor-pointer title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                        ...
                        <span className="ml-3 text-xl">MyShop.com</span>
                        </NavLink>
                    ...
                    <NavLink to={'/cart'}  className="inline-flex items-center bg-indigo-500 text-white border-0 py-1 px-4 focus:outline-none hover:bg-indigo-700 rounded text-base mt-4 md:mt-0">Go To Cart
